...
# 
# pdftohtml - Convert PDF documents into html files.
...
# =============| Modify |=======================================+
        ...
        self.button_convert.clicked.connect(self.convert_html)

# ==============================================================+

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "PDF to html"))
        self.groupBox.setTitle(_translate("MainWindow", "PDF to html"))
...
# ======================================| Modify |=================================================================================+
    ...
    def convert_html(self):
        ...
        # Concatenate the paths of the files stored in the list to the 'self.command' command
            ...
            file_name, _ = QFileDialog.getSaveFileName(MainWindow, "Save File", ".html", "HTML Files (*.html)", options=options)
